...
Public Class ColumnLedger
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "EuroAccounting.ColumnLedger.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedColumnLedger
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ColumnLedger = New ColumnLedger()
        rpt.Site = Me.Site
        Return rpt
    End Function
